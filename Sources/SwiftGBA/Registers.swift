...
public enum Register {
    ...
    public static var interruptFunctionBIOS: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress - 0x0008)
    }

    /// Memory address that the system will jump to after a soft reset
    public static var softResetDestination: VolatileMappedRegister<UInt16> {
    ...
    public static var background0HorizontalOffset: VolatileMappedRegister<UInt16> {
    ...
    public static var background0VerticalOffset: VolatileMappedRegister<UInt16> {
    ...
    public static var background1HorizontalOffset: VolatileMappedRegister<UInt16> {
    ...
    public static var background1VerticalOffset: VolatileMappedRegister<UInt16> {
    ...
    public static var background2HorizontalOffset: VolatileMappedRegister<UInt16> {
    ...
    public static var background2VerticalOffset: VolatileMappedRegister<Int16> {
    ...
    public static var background3HorizontalOffset: VolatileMappedRegister<Int16> {
    ...
    public static var background3VerticalOffset: VolatileMappedRegister<Int16> {
    ...
    public static var windowOutsideControl: VolatileMappedRegister<Int16> {
    ...
    public static var window0Right: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0040)
    }

    /// Window 0 Left Coordinate
    public static var window0Left: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0041)
    }

    /// Window 1 Right Coordinate
    public static var window1Right: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0042)
    }

    /// Window 1 Left Coordinate
    public static var window1Left: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0043)
    }

    /// Window 0 Bottom Coordinate
    public static var window0Bottom: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0044)
    }

    /// Window 0 Top Coordinate
    public static var window0Top: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0045)
    }

    /// Window 1 Bottom Coordinate
    public static var window1Bottom: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0046)
    }

    /// Window 1 Top Coordinate
    public static var window1Top: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0047)
    }

    /// Window 0 Layer Control
    public static var window0Control: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0048)
    }

    /// Window 1 Layer Control
    public static var window1Control: VolatileMappedRegister<UInt8> {
        .init(unsafeBitPattern: baseAddress + 0x0049)
    }

    /// Outside Window Layer Control
    public static var windowOutsideLayerControl: VolatileMappedRegister<Int8> {
        .init(unsafeBitPattern: baseAddress + 0x004A)
    }

    /// Object Window Layer Control
    public static var windowObjectControl: VolatileMappedRegister<Int8> {
    ...
    public static var sound2Control: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0068)
    }

    /// Channel 2 Frequency - Controls sound frequency and reset
    public static var sound2Frequency: VolatileMappedRegister<Int16> {
    ...
    public static var sound3WaveSelect: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0070)
    }

    /// Channel 3 Control - Controls volume and playback length
    public static var sound3Control: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0072)
    }

    /// Channel 3 Frequency - Controls sound frequency and reset
    public static var sound3Frequency: VolatileMappedRegister<UInt16> {
    ...
    public static var sound4Control: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0078)
    }

    /// Channel 4 Frequency - Controls noise parameters and reset
    public static var sound4Frequency: VolatileMappedRegister<Int16> {
    ...
    public static var wavePatternRAM: VolatileMappedRegister<UInt32> {
        .init(unsafeBitPattern: baseAddress + 0x0090)
    }

    /// Wave Pattern RAM Bank 0
    public static var wavePatternRAM0: VolatileMappedRegister<UInt32> {
        .init(unsafeBitPattern: baseAddress + 0x0090)
    }

    /// Wave Pattern RAM Bank 1
    public static var wavePatternRAM1: VolatileMappedRegister<UInt32> {
        .init(unsafeBitPattern: baseAddress + 0x0094)
    }

    /// Wave Pattern RAM Bank 2
    public static var wavePatternRAM2: VolatileMappedRegister<UInt32> {
        .init(unsafeBitPattern: baseAddress + 0x0098)
    }

    /// Wave Pattern RAM Bank 3
    public static var wavePatternRAM3: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x009C)
    }

    /// Direct Sound Channel A FIFO Buffer
    public static var directSoundFIFOA: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00A0)
    }

    /// Direct Sound Channel B FIFO Buffer
    public static var directSoundFIFOB: VolatileMappedRegister<Int32> {
    ...
    public static var dma0SourceAddress: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00B0)
    }

    /// DMA 0 Destination Address Register
    public static var dma0DestinationAddress: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00B4)
    }

    /// DMA 0 Control Register
    public static var dma0Control: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00B8)
    }

    /// DMA 1 Source Address Register
    public static var dma1SourceAddress: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00BC)
    }

    /// DMA 1 Destination Address Register
    public static var dma1DestinationAddress: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00C0)
    }

    /// DMA 1 Control Register
    public static var dma1Control: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00C4)
    }

    /// DMA 2 Source Address Register
    public static var dma2SourceAddress: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00C8)
    }

    /// DMA 2 Destination Address Register
    public static var dma2DestinationAddress: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00CC)
    }

    /// DMA 2 Control Register
    public static var dma2Control: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00D0)
    }

    /// DMA 3 Source Address Register
    public static var dma3SourceAddress: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00D4)
    }

    /// DMA 3 Destination Address Register
    public static var dma3DestinationAddress: VolatileMappedRegister<Int32> {
        .init(unsafeBitPattern: baseAddress + 0x00D8)
    }

    /// DMA 3 Control Register
    public static var dma3Control: VolatileMappedRegister<Int32> {
    ...
    /// Timer 0 Count Value
    public static var timer0Count: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0100)
    }

    /// Timer 0 Control Register
    public static var timer0Control: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0102)
    }

    /// Timer 1 Count Value
    public static var timer1Count: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0104)
    }

    /// Timer 1 Control Register
    public static var timer1Control: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0106)
    }

    /// Timer 2 Count Value
    public static var timer2Count: VolatileMappedRegister<UInt16> {
        .init(unsafeBitPattern: baseAddress + 0x0108)
    }

    /// Timer 2 Control Register
    public static var timer2Control: VolatileMappedRegister<Int16> {
        .init(unsafeBitPattern: baseAddress + 0x010A)
    }

    /// Timer 3 Count Value
    public static var timer3Count: VolatileMappedRegister<Int16> {
        .init(unsafeBitPattern: baseAddress + 0x010C)
    }

    /// Timer 3 Control Register
    public static var timer3Control: VolatileMappedRegister<Int16> {
    ...
    public static var serialControl: VolatileMappedRegister<UInt16> {
    ...
    public static var serialIOControl: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0128) }

    /// General-purpose 32-bit Serial Data Register
    /// Used for both Normal and UART mode data transfer
    public static var serialData32Bit: VolatileMappedRegister<UInt32> { .init(unsafeBitPattern: baseAddress + 0x0120) }

    /// 8-bit Serial Data Register
    /// Used for byte-wise communication in Normal/UART modes
    public static var serialData8Bit: VolatileMappedRegister<Int16> { .init(unsafeBitPattern: baseAddress + 0x012A) }

    /// Multiplayer Communication Data Array
    /// Contains all data for 4-player communication mode
    public static var multiplayerDataArray: VolatileMappedRegister<Int16> { .init(unsafeBitPattern: baseAddress + 0x0120) }

    /// Multiplayer Master Device Data Register
    /// Contains data from the controlling GameBoy Advance
    public static var multiplayerMasterData: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0120) }

    /// Multiplayer Slave Device 1 Data Register
    /// Contains data from the first connected slave device
    public static var multiplayerSlave1Data: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0122) }

    /// Multiplayer Slave Device 2 Data Register
    /// Contains data from the second connected slave device
    public static var multiplayerSlave2Data: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0124) }

    /// Multiplayer Slave Device 3 Data Register
    /// Contains data from the third connected slave device
    public static var multiplayerSlave3Data: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0126) }

    /// Multiplayer Data Receive Register
    /// Buffer for incoming multiplayer communication data
    public static var multiplayerDataReceiver: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0120) }

    /// Multiplayer Data Transmit Register
    /// Buffer for outgoing multiplayer communication data
    public static var multiplayerDataSender: VolatileMappedRegister<Int16> { .init(unsafeBitPattern: baseAddress + 0x012A) }
    ...
    public static var keyInputStatus: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0130) }
    ...
    public static var keyInterruptControl: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0132) }
    ...
    public static var serialModeSelect: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0134) }

    /// JoyBus Communication Control Register
    /// Controls the JoyBus communication protocol settings
    public static var joyBusControl: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0140) }

    /// JoyBus Receive Data Register
    /// Buffer for incoming JoyBus communication data
    public static var joyBusReceiveData: VolatileMappedRegister<UInt32> { .init(unsafeBitPattern: baseAddress + 0x0150) }

    /// JoyBus Transmit Data Register
    /// Buffer for outgoing JoyBus communication data
    public static var joyBusTransmitData: VolatileMappedRegister<UInt32> { .init(unsafeBitPattern: baseAddress + 0x0154) }

    /// JoyBus Communication Status Register
    /// Contains flags indicating JoyBus connection and transfer status
    public static var joyBusStatus: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0158) }
    ...
    public static var interruptEnable: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0200) }

    /// Interrupt Flag Register
    /// Shows which interrupts are currently pending
    /// Writing 1 to a bit acknowledges the corresponding interrupt
    public static var interruptFlags: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0202) }

    /// Wait State Control Register
    /// Controls memory access timing for different memory regions
    /// Affects ROM, SRAM, and other external memory access speeds
    public static var waitStateControl: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0204) }

    /// Interrupt Master Enable Register
    /// Global enable/disable for all hardware interrupts
    /// Must be set to 1 for any interrupts to fire
    public static var interruptMasterEnable: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0208) }

    /// System Pause Control Register
    /// Controls system pause functionality
    /// Exact behavior may vary between hardware revisions
    public static var systemPauseControl: VolatileMappedRegister<UInt16> { .init(unsafeBitPattern: baseAddress + 0x0300) }
}